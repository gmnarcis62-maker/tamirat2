    ...
    private fun loadGuide() {
        val sampleSteps = listOf(
            ...
            RepairStepItem(
                ...
                description = """
                    دستگاه را به منبع تغذیه DC وصل کنید. ولتاژ را روی 4.2V و جریان محدود را روی 1A تنظیم کنید. کلید Power را فشار دهید و جریان‌کشی را مشاهده کنید.
            ...
            RepairStepItem(
                ...
                description = """
                    مولتی‌متر را روی حالت DC Voltage قرار دهید. پروب مشکی را به GND برد و پروب قرمز را به پد VBAT وصل کنید.

                    ولتاژ نرمال: 3.7V تا 4.4V

                    اگر ولتاژ کمتر از 3.5V است، باتری خالی یا خراب است. اگر ولتاژ صفر است، مسیر VBAT قطع یا کوتاه است.
                """.trimIndent(),
            ...
            RepairStepItem(
                ...
                description = """
                    کلید Power را از نظر فیزیکی بررسی کنید. با مولتی‌متر حالت Buzzer، دو سر کلید را در حالت فشار داده و رها شده تست کنید.
            ...
            RepairStepItem(
                ...
                description = """
                    PMIC (Power Management IC) را شناسایی کنید. معمولاً بزرگترین IC در اطراف باتری است.
            ...
            RepairStepItem(
                ...
                description = """
                    دستگاه را به منبع تغذیه وصل کنید و ولتاژ را به آرامی افزایش دهید. با دست یا دوربین حرارتی، نقاط داغ را شناسایی کنید.
